%{
/* x86/osx lburg spec. Derived from x86.md by
Regan Russell <regan@pymblesoftware.com>
...
static void global(Symbol p) {
        ...
        if (!p->generated) {
// RR:                print(".type %s,@%s\n", p->x.name,
// RR:                        isfunc(p->type) ? "function" : "object");
                if (p->type->size > 0)
