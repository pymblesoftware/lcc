...
char *com[] = {LCCDIR "rcc", "-target=x86/osx", "$1", "$2", "$3", 0 };
//char *as[] = { "/usr/bin/as", "-Q",  "-v", "-arch i386",  "-o", "$3", "$1", "$2", 0 };
char *as[] = { "/Library//Developer/CommandLineTools/usr/libexec/as/i386/as",  "-o", "$3", "$1", "$2", 0 };
char *ld[] = {
