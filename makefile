...
$Bx86osx$O:	$Bx86osx.c;	$(CC) $(CFLAGS) -c -Isrc -o $@ $Bx86osx.c
...
$Bx86osx.c:	$Blburg$E src/x86osx.md; $Blburg src/x86osx.md $@
...
clean::		testclean
		$(RM) $B*$O
		$(RM) $Bdagcheck.c $Balpha.c $Bmips.c $Bx86.c $Bsparc.c $Bx86linux.c $Bx86osx.c
